...
/**
 * Instruction OR - calculates logical alternative from two values
 * OR values from dst and source, result is saved in dst
 *
...
public class InstructionOR extends Instruction {
     ...
     */
    public InstructionOR(Register dst, Register src) {
        this.dst = dst;
        this.src = src;
    }
